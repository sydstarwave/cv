...
<div class="m-auto">
	<div class="print:hidden mb-5">
		...
		<a
			...
			download="Sydney Panesar - the details.pdf"
			><FontAwesomeIcon icon={faFilePdf} class="mr-3" />PDF</a
		>
		<a
	...
	>
			...
			<div class="flex">
				<div>
					...
					<div class="flex items-start mt-1 content-text">
						<ul class="text-gray-600 flex flex-wrap gap-x-4 gap-y-0.5">
							<li>
								<a class="flex gap-1.5 items-center" href={basics.url} target="_blank"
							...
							<li>
								<a
									...
									target="_blank"><FontAwesomeIcon icon={faEnvelope} />{basics.email}</a
								>
							</li>
							...
							<li>
								<p class="flex gap-1.5 items-center">
									<FontAwesomeIcon icon={faMapMarkerAlt} />{basics.location.city}, {basics.location
										.region}, {basics.location.countryCode}
								</p>
							</li>

							<li>
								<p class="flex gap-1.5 items-center">
									<FontAwesomeIcon icon={faFlag} />{basics.nationality}
								</p>
							</li>
							<li>
								<p class="flex gap-1.5 items-center">
									<FontAwesomeIcon icon={faCakeCandles} />{basics.birthdate}
								</p>
							</li>
						</ul>
					</div>
				...
				<div>
					<img
						...
						alt="A headshot of {resume.basics.name}"
					/>
				</div>
			</div>
		</section>
		...
		<section class="pt-4">
			...
			<div class="grid grid-cols-[auto_1fr] mt-2 items-baseline gap-x-2 text-xs content-text">
					...
					<li>
						<div class="flex items-baseline gap-2">
							...
							<p class="text-gray-400 right-text ml-2">
								{experience.startDate}{#if experience.endDate}&nbsp;&dash;&nbsp;{experience.endDate}{/if}
							</p>
						</div>
			...
			{#each resume.education as education}
				<div class="flex justify-between items-baseline mt-2">
					...
					<p class="text-gray-400 right-text">
						{education.startDate}{#if education.endDate}&nbsp;&dash;&nbsp;{education.endDate}{/if}
					</p>
				</div>
				...
				{#each resume.projects as project}
					<li>
						<div class="flex justify-between items-baseline">
							<h3 class="text-gray-700 font-bold title-text flex items-baseline gap-1.5">
								{project.name}
							...
							{#if project.meta.github}
								<ul class="text-gray-400 flex right-text gap-4">
									<li>
										<a class="flex gap-1 items-center" href={project.meta.github} target="_blank"
											><FontAwesomeIcon icon={faGithub} class="print:hidden" />
											{project.meta.github}</a
										>
									</li>
								</ul>
							{:else if project.url}
								<ul class="text-gray-400 flex right-text gap-4">
									<li>
										<a class="flex gap-1 items-center" href={project.url} target="_blank"
											><FontAwesomeIcon icon={faLink} class="print:hidden" />
											{project.url}</a
										>
									</li>
								</ul>
