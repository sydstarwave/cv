...
>
    ...
    <header class="px-5 relative lg:flex pt-40 pb-24 gap-10 text-center">
        ...
        <div data-aos="fade-left" data-aos-delay="200" class="basis-1/2">
            ...
            >
                I have more than 10 years of work experience and counting. Here are some
    ...
    <section class="main max-w-6xl mx-auto mb-40 relative z-10">
        ...
        >
            {#each experiences.work as experience}
                <button
                        class="exp text-left aspect-square flex {experience.meta.background}"
                >
                    <img
                            loading="lazy"
                    ...
                    >
                        ...
                        <h1
                                class="font-bold {experience.meta.highlight} text-lg lg:text-lg mb-1"
                        >
                            @{experience.name}
                        </h1>
