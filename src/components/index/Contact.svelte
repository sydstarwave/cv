<script>
	...
	import { faPaperPlane, faAngleUp } from '@fortawesome/free-solid-svg-icons';
	...
	async function submitForm() {
		...
		if (res.ok) {
			...
			alert(
				'Uh oh... message failed to send. You can email me directly at syndye.panesar[atg]mx.at'
			);
		}
	}
</script>
...
>
	...
	<section class="section relative">
		<div class="bg-gray-50 dark:bg-gray-900 shadow-2xl px-5 md:px-7 py-10 lg:px-10 lg:py-14 mb-16">
			<div>
				<div
					data-aos="flip-up"
					data-aos-delay="600"
			...
			<div class="lg:flex gap-10">
				<div class="basis-2/5">
					...
					<h5 data-aos="fade" class="text-gray-500 dark:text-gray-300 mb-7">
						...
						<button
							...
							on:click={() => copyToClipboard('sydney.panesar[atg]mx.at')}
							>sydney.panesar[atg]mx.at</button
						>
						and
						<button
							class="text-gray-700 dark:text-gray-100 underline"
							on:click={() => copyToClipboard('sydney.panesar[atg]mail.com')}
							>sydney.panesar[atg]mail.com</button
						>
					</h5>
				</div>
				...
				>
					...
					<button
						...
						disabled
						><FontAwesomeIcon icon={faPaperPlane} class="text-xs" />
	...
	>
		<FontAwesomeIcon icon={faAngleUp} class="hover-vertical group-hover:pause" />
	</button>
</section>
