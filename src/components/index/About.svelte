            ...
            <div class="max-w-xs z-10 flex-1">
                ...
                >
                    <img
                            ...
                            data-aos-delay="200"
                            src="/img/me.webp"
                            alt="A photo of {resume.basics.name} in front of a river in Lower Austria"
                    />
                </div>
            </div>
            ...
            >
                ...
                >
                    <p class="first-letter:text-4xl first-letter:font-bold">
                        Hey there! I'm Sydney - a software architect and philanthropist from
                        Southern California, USA currently living near Vienna, Austria.
                    </p>
                    <p class="indent-4">
                        I am a computer enthusiast first and foremost - computing is both
                        a job and a hobby. One of my core philosophies is: If you love
                        what you do you'll never <i>work</i> a day in your life.
                    </p>
                    <p class="indent-4">
                        Most of my practical experience comes from full-stack web development,
                        my stack of choice being Linux, PostgreSQL, Golang, and Svelte.
                        When I'm not constructing programs I enjoy taking them apart using tools
                        like Ghidra for reverse engineering.
                    </p>
                </div>
            </div>
        </div>
